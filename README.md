...
explainer = ModelExplainer(model_path, model_type='resnet50')

# Explain single image
explanations = explainer.explain_image(
    "path/to/image.jpg",
    methods=['lime', 'gradcam'],
    save_path="explanation.png"
)

# Evaluate model
evaluator = ModelEvaluator(model_path, model_type='resnet50')
...
- **Datasets**: Thanks to the creators of the casting, MVTec, and NEU datasets
- **Libraries**: PyTorch, LIME, SHAP, Captum, Streamlit
- **Inspiration**: Industrial AI and explainable machine learning research
